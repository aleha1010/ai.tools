...
1. **Загрузи skill** `review-dba` с помощью skill tool
  ...
  "findings": [
    {
      ...
      "section": "ORM|SQL Queries|Indexes|Migrations|Transactions|Connection Management",
      "line_start": 42,
      "line_end": 45,
...
- Фокус на критических проблемах БД (HIGH)
- Предоставлять конкретные suggestions с примерами SQL/кода
