...
1. **Загрузи skill** `review-security` с помощью skill tool
  ...
  "findings": [
    {
      ...
      "section": "Injection|Authentication|Sensitive Data|XSS|Access Control|Dependencies|Logging|Configuration",
      "line_start": 42,
      "line_end": 45,
...
- Фокус на критических проблемах безопасности (HIGH)
