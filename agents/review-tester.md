...
1. **Загрузи skill** `review-tester` с помощью skill tool
  ...
  "findings": [
    {
      ...
      "section": "Structure|Naming|Assertions|Mocks|Coverage|Maintainability|Business Logic|Async|Flakiness|Test Doubles",
      "line_start": 42,
      "line_end": 45,
...
- Фокус на критических проблемах качества тестов (HIGH)
